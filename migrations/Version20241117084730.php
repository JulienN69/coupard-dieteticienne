 ...
 */
final class Version20241117084730 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE recipe_ingredient ADD quantity DOUBLE PRECISION NOT NULL, CHANGE recipe_id recipe_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE recipe_ingredient DROP FOREIGN KEY FK_22D1FE1359D8A214');
        $this->addSql('DROP INDEX `PRIMARY` ON recipe_ingredient');
        $this->addSql('ALTER TABLE recipe_ingredient DROP quantity, CHANGE recipe_id recipe_id INT NOT NULL');
